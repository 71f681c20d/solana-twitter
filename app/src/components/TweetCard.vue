...
const { wallet } = useWorkspace() // Anchor workspace composable
const authorRoute = computed(() => {
    // When you click on author, either display your own profile or the author's profile, depending on if its your tweet or not
